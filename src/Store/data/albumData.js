export const albumData = [
  {
    ...
    name: "Anime Girl 1",
    url:
      "https://cdn.animenewsnetwork.com/thumbnails/fit450x450/cms/interest/108993/mio1.png.jpg",
    uploadDate: new Date(),
    discription:
      "The Charapedia website announced the results of a poll on Thursday that asked fans which black-haired female anime and manga characters they find most",
    tag: ["Anime"],
    category: ["Anime", "Amime Girl"],
    user: "Saurav"
  },
  {
    id: 2,
